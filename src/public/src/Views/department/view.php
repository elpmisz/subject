...
<div class="row">
  <div class="col-xl-12">
    <div class="card shadow">
      ...
      <div class="card-body">
        <form action="/department/update" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
          ...
          <div class="row justify-content-center mb-2">
            ...
            <div class="col-xl-3 mb-2">
              <a href="/department" class="btn btn-sm btn-danger btn-block">
